...
app.get('/price/:id', function (req, res) {
  console.log('Calling price service at: ' + 'http://priceservice:30000/price/' + encodeURIComponent(req.params.id));
  request('http://priceservice:30000/price/' + encodeURIComponent(req.params.id), function (error, response, body) {
